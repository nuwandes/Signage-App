...
public class ColomboWhetherActivity extends AppCompatActivity {
    ...
    private String TAG = "WhetherActivity";

    @SuppressLint({"SetTextI18n", "MissingInflatedId"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.whether_activity_colombo);
        ...
        //Log.wtf(TAG, "INTENT_DATA_MAX: " + cMaxList.get(0) + ", MIN: " + cMinList.get(0) + ", DATE: " + cDateList.get(0) + ", CONDITION: " + cConList.get(0));

        tvSatMax.setText(convertFaranToCelci(cMaxList.get(0)) + " \u2103");
        tvSunMax.setText(convertFaranToCelci(cMaxList.get(1)) + " \u2103");
        tvMonMax.setText(convertFaranToCelci(cMaxList.get(2)) + " \u2103");
        tvTueMax.setText(convertFaranToCelci(cMaxList.get(3)) + " \u2103");
        tvWedMax.setText(convertFaranToCelci(cMaxList.get(4)) + " \u2103");

        tvSatMin.setText(convertFaranToCelci(cMinList.get(0)) + " \u2103");
        tvSunMin.setText(convertFaranToCelci(cMinList.get(1)) + " \u2103");
        tvMonMin.setText(convertFaranToCelci(cMinList.get(2)) + " \u2103");
        tvTueMin.setText(convertFaranToCelci(cMinList.get(3)) + " \u2103");
        tvWedMin.setText(convertFaranToCelci(cMinList.get(4)) + " \u2103");

        tvOne.setText(getSimpleDayName(cDateList.get(0)));
        tvTwo.setText(getSimpleDayName(cDateList.get(1)));
        tvThree.setText(getSimpleDayName(cDateList.get(2)));
        tvFour.setText(getSimpleDayName(cDateList.get(3)));
        tvFive.setText(getSimpleDayName(cDateList.get(4)));

        setIcon(cConList.get(0), ivOne);
        setIcon(cConList.get(1), ivTwo);
        setIcon(cConList.get(2), ivThree);
        setIcon(cConList.get(3), ivFour);
        setIcon(cConList.get(4), ivFive);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                Intent intent = new Intent(ColomboWhetherActivity.this, DivisionalGrossQuantitiesActivity.class);
                // colombo data
